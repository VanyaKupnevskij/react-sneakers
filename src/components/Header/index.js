            ...
            <Link to="react-sneakers/">
              <div className={styles.name_block}>
                  ...
                  <div className={styles.name}>
                    <b className={styles.name_title}>REACT SNEAKERS</b>
              ...
              <ul className={styles.menu_list}>
                ...
                <li className={styles.favorite}>
                  <Link to="react-sneakers/favorites">
                    <svg className={styles.favorite_img} width="21" height="19" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className={styles.profile}>
                  <Link to="react-sneakers/profile">
                    <img className={styles.profile_img} src="images/profile.svg" alt="profile"/>
                  </Link>
                </li>
              </ul>
            </nav>
